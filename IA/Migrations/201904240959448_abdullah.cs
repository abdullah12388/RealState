    ...
    public partial class abdullah : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.users", t => t.pCustomer, cascadeDelete: true)
                .ForeignKey("dbo.users", t => t.pPM)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.projects", "pPM", "dbo.users");
            DropForeignKey("dbo.projects", "pCustomer", "dbo.users");
            ...
            DropIndex("dbo.projects", new[] { "pCustomer" });
            DropIndex("dbo.projects", new[] { "pPM" });
